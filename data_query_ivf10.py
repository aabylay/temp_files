...
def queryVector(vector, k, value=None):
    ...
    return [\
        res_ivf_10_1[0].ids, res_ivf_10_3[0].ids, res_ivf_10_10[0].ids, \
        q_time_10_1, q_time_10_3, q_time_10_10 \
    ]
...
for i in range(df_top_res.shape[0]):
    ...
    for k in k_vals.keys():
        ...
        df_temp = pd.DataFrame([[title_id1, "top_100", k, val1, \
                            results[3], recall_ivf_10_1, \
                            results[4], recall_ivf_10_3, \
                            results[5], recall_ivf_10_10]]\
                            columns=columns
                            )
...
df.to_csv("results_df_ivf_full_idx10.csv")
print("Done")
